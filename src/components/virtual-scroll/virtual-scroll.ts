...
export class VirtualScroll implements DoCheck, AfterContentInit, OnDestroy {
  ...
  readUpdate(checkDataChanges: boolean, dimensionsUpdated: boolean) {
    ...
    this._renderer.setElementClass(ele, 'virtual-loading', true);
  ...
  postRenderVirtual() {
    ...
    // ******** DOM READ THEN DOM WRITE ****************
    initReadNodes(nodes, cells, this._data);

    // update the bound context for each node
    updateNodeContext(nodes, cells, this._data);
    ...
    // ******** DOM WRITE ****************
    const lastEle: HTMLElement = this._renderer.createElement(ele, 'div');
    lastEle.className = 'virtual-last';

    // ******** DOM WRITE ****************
    this._renderer.setElementClass(ele, 'virtual-scroll', true);

    // ******** DOM WRITE ****************
    this._renderer.setElementClass(ele, 'virtual-loading', false);
